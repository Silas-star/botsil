	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `opaaa @${num.split('@')[0]}\nBem vindo(a) ao grupo *${mdata.subject}*  😊 mande !lista para a lista do RPG`
